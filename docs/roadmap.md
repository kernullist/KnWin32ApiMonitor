...
6. System DLL coverage waves:
   ...
   - Wave 4: generated definitions for the remaining common Windows user-mode DLLs, with selected OLEAUT32 lifecycle, USERENV environment-block destroy, DNSAPI record-list free, SETUPAPI device-info close, and DbgHelp symbol-session hooks
...
Status: refreshed on 2026-06-20 after low-payload USERENV environment-block destroy coverage.

Current definition coverage:

1. Total APIs: 179.
2. `smoke_verified`: 117.
3. `hooked`: 4.
4. `definition_only`: 58.
