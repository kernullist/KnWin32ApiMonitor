...
1. Total APIs: 179.
2. `smoke_verified`: 120.
3. `hooked`: 4.
4. `definition_only`: 55.
5. Microsoft-source inventory: 18,086 APIs, with 124 Tier 0 rows, 15,937 Tier 1 rows, 655 Tier 2 rows, and 1,370 Tier 3 rows.
