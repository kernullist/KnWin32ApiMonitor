...
The current definition coverage report totals 139 APIs:
...
`defs:decoder-tables` verifies the generated decoder metadata artifact covers API IDs `1` through `139`, parameter rows, decode alias rows, and length-source resolution.
