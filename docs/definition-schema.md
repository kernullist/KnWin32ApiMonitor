...
The current definition coverage report totals 123 APIs:
...
`defs:decoder-tables` verifies the generated decoder metadata artifact covers API IDs `1` through `106`, parameter rows, decode alias rows, and length-source resolution.
