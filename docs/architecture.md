...
`Protocol.h` includes `GeneratedApiIds.h`, so the current compact shared-memory transport API and module IDs are generated from the stable assignment metadata. The generated values preserve the existing File I/O ids `1` through `6`, loader ids `7` through `11`, Wave 2 ids `14` through `90`, Phase 13B User32/GDI32 ids `91` through `97`, Phase 13C PSAPI ids `98` through `101`, Phase 13D Version ids `102` through `104`, Phase 13E Shell ids `105` through `106`, and Phase 13F OLE32 ids `107` through `110`; `psapi.dll` is module id `13`, `version.dll` is module id `14`, `shell32.dll` is module id `15`, and `ole32.dll` is module id `16`.
