...
- The UI can replay the last helper-written sample session into the trace table, Tauri exposes replay by explicit session path for `.knapm`, and the UI can refresh a host-side replay catalog summary.
