...
inline constexpr std::array<KnMonGeneratedApiMetadata, 119> KnMonGeneratedApis =
{{
    {
        1,
        1,
...
inline constexpr std::array<KnMonGeneratedParameterMetadata, 448> KnMonGeneratedParameters =
{{
    {
        1,
        0,
