...
inline constexpr std::array<KnMonGeneratedApiMetadata, 135> KnMonGeneratedApis =
{{
    {
        1,
        1,
...
inline constexpr std::array<KnMonGeneratedParameterMetadata, 495> KnMonGeneratedParameters =
{{
    {
        1,
        0,
