...
inline constexpr std::array<KnMonGeneratedApiMetadata, 128> KnMonGeneratedApis =
{{
    {
        1,
        1,
...
inline constexpr std::array<KnMonGeneratedParameterMetadata, 473> KnMonGeneratedParameters =
{{
    {
        1,
        0,
