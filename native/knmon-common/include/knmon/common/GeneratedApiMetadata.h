...
inline constexpr std::array<KnMonGeneratedApiMetadata, 123> KnMonGeneratedApis =
{{
    {
        1,
        1,
...
inline constexpr std::array<KnMonGeneratedParameterMetadata, 461> KnMonGeneratedParameters =
{{
    {
        1,
        0,
