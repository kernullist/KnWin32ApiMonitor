...
inline constexpr std::array<KnMonGeneratedModuleMetadata, 13> KnMonGeneratedModules =
{{
    {
        1,
        "kernel32.dll",
...
inline constexpr std::array<KnMonGeneratedApiMetadata, 101> KnMonGeneratedApis =
{{
    {
        1,
        1,
...
inline constexpr std::array<KnMonGeneratedParameterMetadata, 404> KnMonGeneratedParameters =
{{
    {
        1,
        0,
