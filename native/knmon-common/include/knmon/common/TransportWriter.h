...
// Compiled with /EHsc independently of hook-side /EHa lifetime unwinding.
TransportWriteOutcome InvokeTransportCallback(void* context, TransportWriteCallback callback,
    TransportReservation* reservation) noexcept;
