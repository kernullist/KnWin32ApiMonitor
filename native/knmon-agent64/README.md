...
4. Exports `KnMonAgentStop` for Phase 11A self-disable/no-unload detach.
...
12. Shares the implementation source used by `knmon-agent32`, with architecture and DLL labels selected at build time.
