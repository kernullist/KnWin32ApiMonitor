...
- Wave 4 common-DLL metadata for `oleaut32.dll`, `secur32.dll`, `userenv.dll`, `dnsapi.dll`, `iphlpapi.dll`, `setupapi.dll`, `shlwapi.dll`, `wintrust.dll`, and `dbghelp.dll`, with stable generated IDs and a first low-payload DbgHelp symbol-session hook slice.
