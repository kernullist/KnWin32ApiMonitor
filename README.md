...
3. Persistent long-running attach/detach daemon supervision, repeated same-process reattach after self-disable, and cancellation-safe process-tree sessions.
