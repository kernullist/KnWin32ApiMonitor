...
- Definition System V1 with JSON Schema validation, decode metadata registries, deterministic API/module id generation, Rohitab XML importer fixtures, coverage reporting, and DLL batch promotion planning.
...
- Tier 1, Tier 2, Tier 3, and DLL batch generated hook-plan artifacts for opt-in broad coverage planning, including Tier 2 API-set host resolution, missing-parameter return-only policies, Tier 3 design-review classification, and same-DLL promotion grouping with zero broad runtime hooks enabled by default.
