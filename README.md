...
- Wave 4 common-DLL metadata for `oleaut32.dll`, `secur32.dll`, `userenv.dll`, `dnsapi.dll`, `iphlpapi.dll`, `setupapi.dll`, `shlwapi.dll`, `wintrust.dll`, and `dbghelp.dll`, with stable generated IDs and low-payload OLEAUT32 lifecycle, DNSAPI record-list free, SETUPAPI device-info close, and DbgHelp symbol-session hook slices.
