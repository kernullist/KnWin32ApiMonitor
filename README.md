...
39. Phase 11E collector reader foundation that factors shared-memory transport record validation, committed-record consumption, bounded drain, and transport metric snapshots into reusable collector-core code while preserving bounded helper command behavior.
...
3. Persistent long-running attach/detach daemon supervision, repeated same-process reattach after self-disable, threaded streaming reader sessions, and cancellation-safe process-tree sessions.
