...
2. `knmon-native-helper.exe attach-capture --pid <pid>` runs same-bitness, process-existence, agent-architecture, protected-process, process signature mitigation, and access preflight before remote mutation.
