...
- Tier 1 and Tier 2 generated hook-plan artifacts for opt-in broad coverage planning, including Tier 2 API-set host resolution and missing-parameter return-only policies.
