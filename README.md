...
- Tier 1, Tier 2, and Tier 3 generated hook-plan artifacts for opt-in broad coverage planning, including Tier 2 API-set host resolution, missing-parameter return-only policies, and Tier 3 design-review classification with zero runtime hooks enabled by default.
