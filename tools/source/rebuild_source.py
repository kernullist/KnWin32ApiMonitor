...
COMMON_TESTS = {"stack-capture", "capture-history", "session-codec", "ipc-security", "bounded-json", "runtime-support", "transport-security",
                ...
                "abi-differential", "capture-semantics", "capture-delayed-collector", "capture-stream-retention", "capture-consumer-failure", "module-lifecycle", "corpus-control", "readiness-delivery"}
